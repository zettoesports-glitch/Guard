...
UIDeleteCharacterWarning::UIDeleteCharacterWarning(UISceneManager *manager) : UIBase()
{
	if (manager != nullptr)
	{
	...
	// Initialize
	{
		...
		_AcceptButton = new UIButton(MESSAGEBOX::MESSAGE_DELETECHARACTER_ACCEPTBUTTON, manager, this, SCREEN_WIDTH, SCREEN_HEIGHT, ACCEPT_POSX, ACCEPT_POSY, BUTTON_WIDTH, BUTTON_HEIGHT);
		...
		_CancelButton = new UIButton(MESSAGEBOX::MESSAGE_DELETECHARACTER_CANCELBUTTON, manager, this, SCREEN_WIDTH, SCREEN_HEIGHT, CANCEL_POSX, CANCEL_POSY, BUTTON_WIDTH, BUTTON_HEIGHT);
...
UIDeleteCharacterWarning::~UIDeleteCharacterWarning()
{

}

void UIDeleteCharacterWarning::Update(mu_uint64 CurrentTime)
{

}

void UIDeleteCharacterWarning::PostDraw()
{
	DrawFrame();
	DrawText();
	DrawButton();
...
void UIDeleteCharacterWarning::DrawFrame()
{
	_BackFrame->Draw();
}

void UIDeleteCharacterWarning::DrawText()
{
	FONT_NORMAL->DrawStringC2D(TEXTINDEX::MESSAGEBOX_DELETECHARACTER,
...
void UIDeleteCharacterWarning::DrawButton()
{
	_AcceptButton->Draw();
	_CancelButton->Draw();
...
mu_uint32 UIDeleteCharacterWarning::OnPreKeyPressed(const SDL_Keysym &key)
{
	switch (key.scancode)
	{
...
UIBase *UIDeleteCharacterWarning::GetFocus(mu_int32 mouseX, mu_int32 mouseY)
{
