#ifndef __MU_PETACTIONCOLLECTERADD_H__
#define __MU_PETACTIONCOLLECTERADD_H__

#pragma once

class MUPetActionCollecterAdd : public MUPetAction
{
public:
	MUPetActionCollecterAdd();
	~MUPetActionCollecterAdd();
...
extern MUPetActionCollecterAdd g_PetActionCollecterAdd;
