#ifndef __MU_PETACTIONUNICORN_H__
#define __MU_PETACTIONUNICORN_H__

#pragma once

class MUPetActionUnicorn : public MUPetAction
{
public:
	MUPetActionUnicorn();
	~MUPetActionUnicorn();
...
extern MUPetActionUnicorn g_PetActionUnicorn;
