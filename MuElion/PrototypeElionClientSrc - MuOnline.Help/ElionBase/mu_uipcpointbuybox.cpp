...
UIPCPointBuyBox::UIPCPointBuyBox(UISceneManager *manager) : UIBase()
{
	if (manager != nullptr)
	{
	...
	// Initialize
	{
		...
		_AcceptButton = new UIButton(MESSAGEBOX::MESSAGE_PCPOINTBUY_ACCEPTBUTTON, manager, this, SCREEN_WIDTH, SCREEN_HEIGHT, ACCEPT_POSX, ACCEPT_POSY, BUTTON_WIDTH, BUTTON_HEIGHT);
		...
		_CancelButton = new UIButton(MESSAGEBOX::MESSAGE_PCPOINTBUY_CANCELBUTTON, manager, this, SCREEN_WIDTH, SCREEN_HEIGHT, CANCEL_POSX, CANCEL_POSY, BUTTON_WIDTH, BUTTON_HEIGHT);
...
UIPCPointBuyBox::~UIPCPointBuyBox()
{

}

void UIPCPointBuyBox::Update(mu_uint64 CurrentTime)
{

}

void UIPCPointBuyBox::Draw3D()
{
	_SlotCount = 0;
...
void UIPCPointBuyBox::DrawFrame()
{
	_Back->Draw();
	_Top->Draw();
	_Middle->Draw();
...
void UIPCPointBuyBox::DrawText()
{
	FONT_BOLD->DrawStringC2D(TEXTINDEX::PCPOINTBUY_LINE1,
...
void UIPCPointBuyBox::DrawButton()
{
	_AcceptButton->Draw();
	_CancelButton->Draw();
...
mu_uint32 UIPCPointBuyBox::OnPreKeyPressed(const SDL_Keysym &key)
{
	switch (key.scancode)
	{
...
UIBase *UIPCPointBuyBox::GetFocus(mu_int32 mouseX, mu_int32 mouseY)
{
