#ifndef __MU_MODEL_LIST_H__
#define __MU_MODEL_LIST_H__

#pragma once

enum MODEL_ENUM : mu_uint32
{
	//nature
	...
	//animal
	MODEL_BIRD01 = MODEL_FACE + GAME::MAX_CLASS,
	...
	MODEL_MULTI_SHOT1 = (MODEL_QUEST + MAX_QUEST_ITEM),
	MODEL_MULTI_SHOT2,
	MODEL_MULTI_SHOT3,
	MODEL_MASK_HELM,
	MODEL_MASK_HELM_END = (MODEL_MASK_HELM + MAX_ITEM_INDEX),
...
namespace MODELS
{
	extern MULoadingData *LoadData[MAX_MODELS];

	extern MUModel Data[MAX_MODELS];
	extern MULoadingData Load[];
	extern const mu_uint32 LoadCount;

	extern MULoadingData Lorencia[];
	extern const mu_uint32 LorenciaCount;
};
