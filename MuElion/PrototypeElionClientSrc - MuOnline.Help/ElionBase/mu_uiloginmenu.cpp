...
#define OPTION_POSY (WINDOW_POSY + 33.0f + (OPTION_HEIGHT + 4.0f) * 1.0f)

#define CLOSE_WIDTH 108.0f
#define CLOSE_HEIGHT 30.0f
#define CLOSE_POSX (WINDOW_POSX + (WINDOW_WIDTH - EXIT_WIDTH) * 0.5f)
#define CLOSE_POSY (WINDOW_POSY + 33.0f + (OPTION_HEIGHT + 4.0f) * 2.0f)

UILoginMenu::UILoginMenu(UISceneManager *manager) : UIBase()
{
	if (manager != nullptr)
	{
	...
	// Initialize
	{
		...
		_ExitButton = new UIButton(OPTIONUI::MESSAGE_LOGIN_EXITBUTTON, manager, this, SCREEN_WIDTH, SCREEN_HEIGHT, EXIT_POSX, EXIT_POSY, EXIT_WIDTH, EXIT_HEIGHT);
		...
		_OptionButton = new UIButton(OPTIONUI::MESSAGE_LOGIN_OPTIONBUTTON, manager, this, SCREEN_WIDTH, SCREEN_HEIGHT, OPTION_POSX, OPTION_POSY, OPTION_WIDTH, OPTION_HEIGHT);
		...
		_CloseButton = new UIButton(OPTIONUI::MESSAGE_LOGIN_CLOSEBUTTON, manager, this, SCREEN_WIDTH, SCREEN_HEIGHT, CLOSE_POSX, CLOSE_POSY, CLOSE_WIDTH, CLOSE_HEIGHT);
...
void UILoginMenu::Update(mu_uint64 CurrentTime)
{

}

void UILoginMenu::Draw()
{
	_BackFrame->Draw();
	_TopFrame->Draw();
	_BottomFrame->Draw();
...
UIBase *UILoginMenu::GetFocus(mu_int32 mouseX, mu_int32 mouseY)
{
