#ifndef __MU_UI_BUTTON_H__
#define __MU_UI_BUTTON_H__

#pragma once

#define UI_BUTTON_FLAG (GFX_FLAG::GFX_NONE)
#define UI_BUTTON_EVENT (GFX_EVENT::GFX_MOUSE_EVENT | GFX_EVENT::GFX_MOUSE_DBLCLICK_AS_CLICK)

class UIButton : public UIRenderTextureBase
{
public:
	UIButton(mu_uint32 objectId, UISceneManager *manager, UIBase *owner, mu_float aspectWidth, mu_float aspectHeight, mu_float x, mu_float y, mu_float width, mu_float height, mu_uint32 flag = UI_BUTTON_FLAG, mu_uint32 event = UI_BUTTON_EVENT);
	~UIButton();
	...
	void SetStateText(const mu_uint32 index, MUTextSimpleRender *font = nullptr, const mu_text *text = _T(""), mu_uint32 textColor = MU::MakeARGB(255, 255, 255, 255), mu_uint32 backColor = MU::MakeARGB(0, 0, 0, 0), mu_float marginX = 0.0f, mu_float marginY = 0.0f, mu_uint8 HorizontalAlign = ETA_CENTER);
