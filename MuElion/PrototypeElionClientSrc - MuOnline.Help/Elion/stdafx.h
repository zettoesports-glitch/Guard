...
#define ELION_WINDOWS_DEVICE (1)
#define ELION_MOBILE_DEVICE (0)
#define BACKEND_FORCE_DEBUGREPORT (1)

#include "mu_directx_config.h"
#include "mu_opengl_config.h"
#include "mu_vulkan_config.h"
#include "mu_metal_config.h"
...
#define USE_COMPRESSED_VERTICES // Use half-float models
#define USE_COMPRESSED_INSTANCES
#define USE_COMPRESSED_TERRAINLIGHT_RGB8
#define USE_COMPRESSED_TERRAINALPHA_R8
#define USE_FAST_TERRAIN_COLLISION
#define USE_SIMD_COLLISION

//#define USE_RENDERING_DISABLE_FLAGS
...
#if !defined(USE_VLD) && !defined(USE_CRTLEAK) && (0)
...
#else
#define SERVER_ADDRESS _T("192.168.0.22")
#endif
...
/*
	Video Backend
*/
#include "mu_video_enum.h"
#include "mu_video_common.h"
#include "mu_shader_enum.h"
#include "mu_shader_list.h"
#include "mu_shader_structures.h"
#include "mu_directx_backend.h"
#include "mu_opengl_backend.h"
#include "mu_vulkan_backend.h"
#include "mu_video_backend.h"
#include "mu_video_attributes.h"
#include "mu_video_pipeline.h"
#include "mu_video_buffers.h"
#include "mu_video_buffer.h"
#include "mu_video_texture.h"
#include "mu_video_model.h"
