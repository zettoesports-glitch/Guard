...
void mu_glColor4fv(const MUCompatGLfloat* c);
...
void mu_glLoadMatrixf(const MUCompatGLfloat* matrix);
void mu_glMultMatrixf(const MUCompatGLfloat* matrix);
...
void mu_glScissor(MUCompatGLint x, MUCompatGLint y, MUCompatGLsizei width, MUCompatGLsizei height);
...
void mu_glCullFace(MUCompatGLenum face);
...
void mu_glShadeModel(MUCompatGLenum mode);
...
void mu_glPopAttrib();
void mu_glPushClientAttrib(MUCompatGLbitfield mask);
void mu_glPopClientAttrib();
...
#define glTexCoord2fv mu_glTexCoord2fv
...
#define glLoadMatrixf mu_glLoadMatrixf
#define glMultMatrixf mu_glMultMatrixf
...
#define glPushClientAttrib mu_glPushClientAttrib
#define glPopClientAttrib mu_glPopClientAttrib
#define glNormal3f mu_glNormal3f
#define glNormal3fv mu_glNormal3fv
